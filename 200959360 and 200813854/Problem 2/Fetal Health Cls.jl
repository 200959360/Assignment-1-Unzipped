...
md"# Assignment 1: Assessment Criteria: Using Classifiers"

# ╔═╡ 56ca10e5-66f4-4f37-8afb-995a506e65e6
"""200959360_Niilenge Aina Mwatile and 200813854_Kakoto Johanna"""

# ╔═╡ f68aaa57-56ea-4c1b-ba70-31c8d5612b7f
md"""In this notebook, we build different types of classifiers to predict a fetus's health. The algorithms used are logistic regression and a tree-based approach. """

# ╔═╡ 6982f2b1-a366-4c5c-ba65-5e75e66750cd
md"## Data Exploration"

# ╔═╡ bacef7f2-a675-4e0f-a58e-c028835f3c81
ads_df = DataFrame(CSV.File("../problem 2/fetal_health.csv", header=1))
...
# data(ads_df) *
#     visual(Violin) *
#     mapping(:"baseline value", :"fetal_movement",  color=:fetal_health) |> draw()

# ╔═╡ 9ec89979-63cf-47a3-b7b0-a7eedeca42cc
schema(ads_df)

# ╔═╡ cee65536-ebbc-4b45-8e19-2033f1fda778
describe(ads_df)
...
levels(ads_df.fetal_health)

# ╔═╡ 137168fa-d1c4-41d0-9826-7de00cb83a93
schema(ads_df)

# ╔═╡ d80c5c4a-0921-4b17-a2a0-14f06ebdd670
"""All the datatype is the same for all columns hance no coecing of data needed."""

# ╔═╡ 28749c3c-07ba-49cf-a853-df7154498d76
coerce!(ads_df, :fetal_health => OrderedFactor)

# ╔═╡ 2cf13803-17dd-4eb1-95e2-a3e69cf38860
y, X = unpack(ads_df, ==(:fetal_health))

# ╔═╡ 27afcaa5-00bd-41dc-9deb-48ee7855b13f
fetal_mach = machine(OneHotEncoder(), X) |> fit!

# ╔═╡ 80df7134-e1be-4011-8c42-7c2bba92f7f3
fetal_feature_df = MLJ.transform(fetal_mach, X)

# ╔═╡ 265d7421-c4b2-45f9-af99-d989d97d7cb0
schema(fetal_feature_df) |> DataFrames.DataFrame
...
log_cla_mach = machine(log_cla, fetal_feature_df, y)
...
cm_log = confmat(mode.(ŷ_test1), y[test_set])

# ╔═╡ d26ad3a7-9334-4189-b203-92f017269435
accuracy(cm_log)
...
cm_tbc = confmat(mode.(ŷ_test), y[test_set])

# ╔═╡ 9c02392e-2b9e-4920-90f1-0271d396cce3
accuracy(cm_tbc)

# ╔═╡ 81acb4aa-c475-4cd3-ae05-0cf419b4f948
md"""We can conclude that the Tree-Base Classifers is more accurate than the Logic Calassifiers with 94,35 percent accuracy"""
...
manifest_format = "2.0"
project_hash = "4d0e847ee196354e315cb46d1f4a18b5ee4835ec"
