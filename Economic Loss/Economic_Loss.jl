...
# ╔═╡ b27a92d1-2799-4f04-814f-a2cb638006bd
using Random

# ╔═╡ 5fdc42ee-f01e-4045-874d-1958ad96ee67
PlutoUI.TableOfContents()

# ╔═╡ 5f95dc69-fe00-4197-bfaa-754e20ea19c9
"""200959360_Niilenge Aina Mwatile and 200813854_Kakoto Johanna"""

# ╔═╡ 318a5811-10f0-4545-abfb-5a87e473f622
md"""This notebook contains a prediction model for economic loss due to fruit wastage. """

# ╔═╡ cf2ca46a-aeec-4946-9c1a-89ceaf994b13
md"## Data Loading"

# ╔═╡ 1655d8a1-23e6-4503-9caa-43f4617fe7bc
gfw_ds= DataFrame(CSV.File("./global_food_wastage_dataset.csv", header=1))

# ╔═╡ c534503f-61bf-4b27-9545-d2b865b97887
gfw_ds_df = select(gfw_ds, [3,4,5,6,7,8])

# ╔═╡ 3b2d2b15-623c-4b0a-922e-632b96983e33
schema(gfw_ds_df) |> DataFrames.DataFrame

# ╔═╡ 86ba37ac-c322-4b88-966e-02f0e976afc3
Y, X = MLJ.unpack(gfw_ds_df, ==(Symbol("Food Category")), colname -> true)

# ╔═╡ 35e6e8db-f323-4e7c-bfe6-ad75d41c8ac4
names(gfw_ds_df)

# ╔═╡ fb9e1d82-3fd1-41a7-ac2b-e7c291d7d970
describe(gfw_ds_df)

# ╔═╡ 33dc7927-54b5-4319-ae11-6075b570626d
size(gfw_ds_df)

# ╔═╡ a90e80e9-20b6-4ac0-bf34-e437272f615a
for col_name in names(gfw_ds_df)
	println(col_name)
end

# ╔═╡ 4c41ce5e-9341-4d61-818b-3962b9140e35
gfw_df1 = filter(row -> row."Food Category" == "Fruits & Vegetables", gfw_ds_df)

# ╔═╡ 65f6b642-9561-4f43-95e1-cb14ff10bb39
gfw_df2 = select(gfw_df1, [2,3,4,5,6])

# ╔═╡ 7793621a-31fb-4609-bd86-3d8bed8ed879
size(gfw_df2)

# ╔═╡ ff721357-ddf9-45a8-a866-70efd1dda55b
describe(gfw_df2)

# ╔═╡ 885ac3b3-4dad-4283-8411-f4c62d3e5740
cor(Matrix(gfw_df2))

# ╔═╡ 77f1494b-f9fc-4769-915c-7184ea194181
p1 = data(gfw_df2) * mapping(:"Total Waste (Tons)", :"Economic Loss (Million \$)")

# ╔═╡ 41e24c0d-6866-4f88-9dda-ad3b90490e15
p2 = data(gfw_df2) * mapping(:"Avg Waste per Capita (Kg)", :"Economic Loss (Million \$)")

# ╔═╡ df52147e-fa23-4c85-870b-ca097f292eed
p3 = data(gfw_df2) * mapping(:"Population (Million)", :"Economic Loss (Million \$)")

# ╔═╡ 2334bc5a-a440-4ee3-8af1-74dd0138111f
p4 = data(gfw_df2) * mapping(:"Household Waste (%)", :"Economic Loss (Million \$)")

# ╔═╡ 1c8d7a11-9efa-4c03-8b1a-558e8ad05d13
p5 = data(gfw_df2) * mapping(:"Household Waste (%)", :"Economic Loss (Million \$)")

# ╔═╡ 530822d8-7aee-4364-9c14-e34c9a01290c
draw(p1)

# ╔═╡ a7a34dff-49d3-428a-8c69-dad350492457
draw(p2)

# ╔═╡ 52ec7e84-43ad-4bf8-9db9-4d0139952c6c
draw(p3)

# ╔═╡ 60975e93-258f-438f-9d38-fdfa98c06f89
draw(p4)

# ╔═╡ f6607eca-4c95-4b87-89f6-4ce1ff7136ba
draw(p5)

# ╔═╡ 0bfae779-eba9-47d4-9c05-4d961ad0ac85
schema(gfw_df2)

# ╔═╡ 995c72ec-dfab-48f7-951a-c1c457a37b11
schema(gfw_df2) |> DataFrames.DataFrame

# ╔═╡ 5896b8c7-90ae-43ec-a7b9-468181bd7d7d
tw = levels(gfw_df2."Total Waste (Tons)")

# ╔═╡ 45df84a3-e165-4e79-a28a-f5de9a07219b
el = levels(gfw_df2."Economic Loss (Million \$)")

# ╔═╡ 2517b2d4-38bd-4c16-a5e5-f6f6b753ed13
awpc = levels(gfw_df2."Avg Waste per Capita (Kg)")

# ╔═╡ ec46dc72-b67d-4cf0-aa9d-3228d090851a
pop = levels(gfw_df2."Population (Million)")

# ╔═╡ 94efc98a-c41a-4a94-9698-63eb13534e06
hw = levels(gfw_df2."Household Waste (%)")

# ╔═╡ 9cbee8d1-6935-430a-b72f-68a35bfc1956
md"### Prepare Data"

# ╔═╡ 5160d105-b994-4aa8-86d6-cb7b5e350a05
y, x = MLJ.unpack(gfw_df2, ==(Symbol("Economic Loss (Million \$)")), colname -> true)

# ╔═╡ 82a56c44-5e5b-43bb-a4f0-c58560b79986
y

# ╔═╡ 5ddb568d-fdd0-44e9-ad33-8a9f6dfc7fe5
x_gfw_mach = machine(Standardizer(), x)

# ╔═╡ 3e215923-a322-4cbc-8e63-a465ff93b7fe
x

# ╔═╡ e9eb9c68-1e1e-4983-908a-014e0f423477
train_set, test_set = partition(eachindex(y), 0.88)

# ╔═╡ d00bd516-bf28-455c-993c-0b261ace379c
md"### RidgeRegressor"

# ╔═╡ 56ab10b8-6a8a-493c-abc4-646359df67e0
Reg = @load RidgeRegressor pkg = "MLJLinearModels" verbosity=0

# ╔═╡ 5a1c7be0-f7cd-4ead-8a5b-587ce649c70f
reg_model = Reg(solver=Analytical())

# ╔═╡ 3fd40652-3e69-4690-ad7d-21b2cef2363b
ec_pred_machine = machine(reg_model, x, y)

# ╔═╡ d222b7c5-e240-40cd-8aaf-45df5e898ceb
fit!(ec_pred_machine, rows=train_set, verbosity=0)

# ╔═╡ 3061714e-e4ca-4ed9-bafe-8541a9de8016
evaluate!(ec_pred_machine, resampling=CV(nfolds=10,shuffle=true,rng=42),measures=[rms],repeats=3)

# ╔═╡ dcf20ad8-b6d7-4cd6-bd9b-a8256b60618d
ec_pred_params = fitted_params(ec_pred_machine)

# ╔═╡ 37b0ff88-ee4b-4581-9c8d-717b4dba6719
fitted_params(ec_pred_machine)

# ╔═╡ 2c37076a-e9a5-44db-9576-21d5b71ab936
rmse(MLJ.predict(ec_pred_machine, x[train_set,:]), y[train_set])

# ╔═╡ b83a5070-a930-4f27-9b09-c37249b3568b
rmse(MLJ.predict(ec_pred_machine, x[test_set,:]), y[test_set])

# ╔═╡ 4786cb86-9f37-4bf1-8b27-73d9d81892b9
r_lambda = range(reg_model, :(lambda), lower=1, upper=300, scale=:log10)

# ╔═╡ 8d87fad9-56c6-402e-8b1b-a77afe55b412


# ╔═╡ b7e64d2b-9fb6-4882-ac27-2a4fff03b5e9
md"### LinearRegressor"

# ╔═╡ 845d4e94-c295-45a0-81ae-860d46de3d4d
LReg1 = @load LinearRegressor pkg = "MLJLinearModels" verbosity=0

# ╔═╡ d69b6b93-82f7-4e87-9fde-f9f15e75e0ad
reg_model2 = LReg1(solver=Analytical())

# ╔═╡ 8a83b249-2927-4495-a9b1-570b765a064f
l_reg_mach = machine(reg_model2, x, y)

# ╔═╡ b3920bc0-13f5-4fd4-a0d6-2d156dbd2bb6
fit!(l_reg_mach, rows=train_set, verbosity=0)

# ╔═╡ 18972c40-4d30-4f9f-8cad-736efe69a911
evaluate!(l_reg_mach, resampling=CV(nfolds=10,shuffle=true,rng=42),measures=[rms],repeats=3)

# ╔═╡ b35e9bc3-f716-4d2e-91e3-4a2c67d5e334
l_reg_params = fitted_params(l_reg_mach)

# ╔═╡ 2f214bf3-a495-43dd-aad5-fd7524221a21
fitted_params(l_reg_mach)

# ╔═╡ dbb36a55-8590-4154-83bc-8ebd398722ec
rmse(MLJ.predict(l_reg_mach, x[train_set,:]), y[train_set])

# ╔═╡ 643683d9-30b1-4d4d-aa5b-9fe2562275c9
rmse(MLJ.predict(l_reg_mach, x[test_set,:]), y[test_set])

# ╔═╡ 1a4fae88-60b4-46b6-9c77-df4b4cb47e79
md"### Huber Regressor"

# ╔═╡ bd05ebc3-1ec8-4fa8-a360-ce789f6c082e
hreg=@load HuberRegressor pkg= "MLJLinearModels" verbosity=0

# ╔═╡ ff4b40f5-59e2-47f2-b81a-afb3ee0aa9a6
hreg_model=hreg()

# ╔═╡ 4ebfc687-5380-41e8-8a16-347cadcb3f2c
hreg_machine=machine(hreg_model, x, y)

# ╔═╡ b0711132-4d2c-4af0-8751-e48170329a37
fit!(hreg_machine, rows=train_set)

# ╔═╡ 0f2c1b65-1340-4f06-978a-359ce0274a35
evaluate!(hreg_machine, resampling=CV(nfolds=10,shuffle=true,rng=42), measures=[rms], repeats=3)

# ╔═╡ ed7221a3-e5cf-46a6-9c21-07e17008be3d
rmse(MLJ.predict(hreg_machine, X[train_set,:]), y[train_set])

# ╔═╡ 21f866f9-22df-4f37-a02c-303b117c1019
rmse(MLJ.predict(hreg_machine, X[test_set,:]), y[test_set])

# ╔═╡ 81dc08e0-96f3-4615-bc43-da0cf390c39e
md"### Select Features"

# ╔═╡ 4cac2ae0-d41b-4364-89b7-eec3427c66e8
fs_gfw_df = select(gfw_df2, [1,2,3])

# ╔═╡ bc7e38de-95ed-49d5-9f6a-dbd4d200613e
describe(fs_gfw_df)

# ╔═╡ 1ea616da-6b67-4d33-afd6-53a978e9f8ad
y_fs, x_fs = MLJ.unpack(fs_gfw_df, ==(Symbol("Economic Loss (Million \$)")), colname -> true)

# ╔═╡ 7bd755ac-8e22-409e-9993-d6ff85835ee8
x_std_mach = machine(Standardizer(), x_fs)

# ╔═╡ 21b6e8f9-cf85-44de-b3c0-81d8e939d09f
norm_x =MLJ.transform(fit!(x_std_mach), x_fs)

# ╔═╡ 07248ccb-efdb-4678-86e8-62128d632d62
y_std_mach = machine(Standardizer(), y_fs)

# ╔═╡ 76c3a2bb-f793-4dc8-888e-64ea69fcd522
norm_y =MLJ.transform(fit!(y_std_mach), y_fs)

# ╔═╡ 88b92a82-4033-404e-8da6-4bf79056732a
train_set1, test_set1 = partition(eachindex(norm_y), 0.85)

# ╔═╡ bfb324f2-00ea-46e6-ac5a-d7b29945e42a
md"### Linear Model"

# ╔═╡ 2be1989c-0034-461b-ac3e-11975856eed0
l_reg_mach1 = machine(reg_model2, norm_x, norm_y)

# ╔═╡ 89350d2e-78c1-4bc0-a2ca-5bdb2c030c99
fit!(l_reg_mach1, rows=test_set, verbosity=0)

# ╔═╡ cbb56f6b-2882-4ae5-9805-3907dd46dc91
evaluate!(l_reg_mach1, resampling=CV(nfolds=10,shuffle=true,rng=42),measures=[rms],repeats=3)

# ╔═╡ 69e16282-57e4-4658-92cd-d56c5b1691de
l_reg_params1 = fitted_params(l_reg_mach1)

# ╔═╡ 89aec73b-350d-4671-acf4-807b64506825
fitted_params(l_reg_mach1)

# ╔═╡ a5eba9d6-82bb-4f6e-8084-04117958e2a1
rmse(MLJ.predict(l_reg_mach1, norm_x[train_set,:]), norm_y[train_set])

# ╔═╡ 2eb29d6e-6958-48ab-9f6c-c4e113bdf64a
rmse(MLJ.predict(l_reg_mach1, norm_x[test_set,:]), norm_y[test_set])

# ╔═╡ d6cfc85a-f0ab-4df8-b8c1-0954e3623712
md"### RidgeRegressor"

# ╔═╡ ff2efa59-c863-4b4f-a5d6-cffd50d0068b
LReg = @load LinearRegressor pkg = "MLJLinearModels" verbosity=0

# ╔═╡ 71c0772e-21fd-42c4-b745-ad9065f54088
reg_model1 = Reg(solver=Analytical())

# ╔═╡ d4f6ee7d-aad0-426e-a9e9-e8f184429a92
ec_pred_machine1 = machine(reg_model1, norm_x, norm_y)

# ╔═╡ 514d3244-3c79-479b-bfde-78f6a9e832af
fit!(ec_pred_machine1, rows=train_set, verbosity=0)

# ╔═╡ b5c4701d-c5d5-407b-ad85-f8912bb30345
evaluate!(ec_pred_machine1, resampling=CV(nfolds=10,shuffle=true,rng=42),measures=[rms],repeats=3)

# ╔═╡ 4c1277c0-f35e-457a-a778-c4508d6ba0ea
ec_pred_params2 = fitted_params(ec_pred_machine1)

# ╔═╡ 41d32f87-f820-4bde-9e55-168ce1ebf514
fitted_params(ec_pred_machine1)

# ╔═╡ 60f77992-b0ac-460c-846b-9e09acd47f27
rmse(MLJ.predict(ec_pred_machine1, norm_x[train_set,:]), norm_y[train_set])

# ╔═╡ de664a52-cca4-401a-b49c-2ddf0e97c784
rmse(MLJ.predict(ec_pred_machine1, norm_x[test_set,:]), norm_y[test_set])

# ╔═╡ 3303f03f-b6f1-40d3-9ce8-11da19202df2
md"### Selecting the Best Model"

# ╔═╡ b6c5ea96-f630-44ae-90d1-6b291ccbfe6b
md"""Since linear model has yeild a lower Root Mean Sqaure Error; we have selected Linear Regressor to be the best model for predicting  economic loss due to fruit wastage  after normalizing the data."""
...
manifest_format = "2.0"
project_hash = "07b64bf83469c548b839b7e88fdbe6a87fbd1476"
